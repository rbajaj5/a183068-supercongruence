...
stabilization for the first defect.  The separate
[higher-defect theorem](BalaAugustHigherDefectLift.md) rewrites the stronger
modulus as an exact three-level congruence, proves the three-shell and
quartic estimates, and closes the cubic term with a second
Cartier-connection identity.
