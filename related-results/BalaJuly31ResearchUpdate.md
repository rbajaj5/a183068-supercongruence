...
| Bober sporadic follow-up | A295431--A295482 and 12 newly commented records | **Ordinary and half-index packets closed for $p\ge5$:** all 52 ordinary ratios and all eleven $N/2$ variants inherit full $p^{3r}$ towers. Four denominator-three/four integrality targets remain |
...
- the four denominator-three/four global integrality claims remain open, despite exact
