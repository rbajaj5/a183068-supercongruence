...
**Status:** exact reduction and finite verification; the cubic contraction
lemma stated below remains open
...
local lemma.  They do not move to `proved-here` until that lemma is proved
for all integer `m`.
