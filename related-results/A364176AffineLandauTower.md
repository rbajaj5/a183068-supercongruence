...
The [independent parity-transfer certificate](BoberHalfIndexIntegralityTowers.md)
gives a shorter second proof for this record. At odd index $N=2m+1$, its
odd-prime defects transfer to the original Bober Landau function, while the
dyadic valuation reduces to
