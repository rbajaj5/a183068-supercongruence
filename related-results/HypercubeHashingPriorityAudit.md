# Hypercube hashing literature-priority audit

This audit accompanies
[the affine-spectrum specialization](AffineSpectrumHashing.md) and
[the exact difference-matroid law](MatroidHashingLaw.md).
