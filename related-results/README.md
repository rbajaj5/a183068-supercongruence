...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 42 proved here, 17 source-closed, 44 partial, 7 with no explicit open target, no wholly untreated records, and none queued |
...
| 1B-A376 | [A376 Apéry-companion reduction](A376AperyCompanionReduction.md) | Collapses A376458 to one four-binomial sum, proves its ordinary cubic tower and prime-level fifth power, and pairs A376466 with the same shifted A108625 row | Partial resolution; A376466 shifted tower refuted; 5,606 exact checks; only the A376466 ordinary tower and higher A376458 bonus remain open |
...
| 1B-CY | [A351858 cyclotomic-family boundary](A351858CyclotomicFamilyBoundary.md) | Gives two infinite valuation-two counterexample families, at $k=p-1$ and $k=p$, to the conjectured uniform cubic tower | Complete elementary counterexample; named $k=2$ tower remains open |
| 1B-RV | [A263843 reversion reduction](A263843ReversionCoefficientReduction.md) | Uses exact Lagrange inversion to reduce the reversion family to coefficient framing, retaining denominator-prime valuation | Full $p\ge5$ family and ternary divisible-slope subfamily proved; one $p=3$ boundary open |
