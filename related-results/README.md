...
| 4I | [Joint spectrum of the dyadic hypercube defect](DyadicHypercubeJointSpectrum.md) | Reduces every XOR of output coordinates to an alternating convolution matrix and recovers exact joint defect counts from ranks, radicals, and Gauss-sum signs | Complete finite-dimensional theorem and exhaustive checks; classical quadratic-form Fourier theorem |
