...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 46 proved here, 20 source-closed, 37 partial, 7 with no explicit open target, no wholly untreated records, and none queued |
