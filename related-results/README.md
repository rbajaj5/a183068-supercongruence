...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 4 proved here, 12 source-closed, 4 partial, 2 with no explicit open target, and 88 awaiting exact claim extraction |
