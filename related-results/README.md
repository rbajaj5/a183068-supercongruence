...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 19 proved here, 12 source-closed, 16 partial, 3 with no explicit open target, and 60 queued |
