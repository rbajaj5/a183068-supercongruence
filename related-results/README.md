...
| 1B-A376 | [A376 Apéry-companion reduction](A376AperyCompanionReduction.md) | Collapses A376458 to one four-binomial sum, proves its prime-level fifth power, and pairs A376466 with the same shifted A108625 row | Partial resolution; A376466 shifted tower refuted; 1,661 exact checks; the two ordinary towers and higher A376458 bonus remain open |
