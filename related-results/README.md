...
| 1B-I3 | [All eleven Bober half-index variants](BoberHalfIndexIntegralityTowers.md) | Transfers odd-prime valuations to the original Bober Landau functions and resolves the dyadic part by two binary digit-sum identities | Complete elementary proof candidate; 59,467 exact checks; priority pending |
| 1B-I4 | [Four remaining Bober fractional variants](BoberRemainingFractionalIntegralityTowers.md) | Proves a coprime-modulus Landau transfer and exact denominator-prime valuation table for the two third-index and two quarter-index cases | Complete elementary proof candidate; all 15 approved fractional variants closed; 84,338 exact checks; priority pending |
...
| 1B-B52 | [Bober sporadic factorial-ratio packet](BoberSporadicFactorialRatioPacket.md) | Applies the balanced and rational-gamma engines to all 52 Bober ratios and Bala's 15 visible fractional-index variants | Ordinary 52-record tower and all 15 approved fractional-index towers proved for $p\ge5$; no approved packet target remains |
