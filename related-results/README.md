...
| 1B-AUG6 | [Higher August defect reduction](BalaAugustHigherDefectLift.md) | Rewrites the growing-modulus conjecture as one division-free three-level congruence, decomposes it exactly into three interacting valuation shells, and isolates the cubic-kernel and quartic contractions | Exact reduction and sharp boundary; 405 checks; final higher-Frobenius estimate open |
