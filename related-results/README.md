...
| 1B | [Peter Bala's OEIS queue](BalaOeisSupercongruenceQueue.md) | Proves the A365029 boundary family and complete A375178 prime-level odd-power family; closes A333593 via Coster and Jacobsthal--Kazandzidis; separates two deeper towers as computational targets | Two complete elementary proofs, one published-theorem reduction, and 1,175 exact checks; priority preliminary |
