...
| 1B | [Peter Bala's OEIS queue](BalaOeisSupercongruenceQueue.md) | Proves the A365029 boundary family and first two adjacent levels, all three A375178--A375180 prime-level odd-power families (in an arbitrary-dilation theorem), and the A112028/A219562 fifth-power boundaries; closes A333593 via Coster and Jacobsthal--Kazandzidis | Four complete elementary proof packets, published-theorem reductions, and exact checks; priority preliminary |
...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 45 proved here, 20 source-closed, 38 partial, 7 with no explicit open target, no wholly untreated records, and none queued |
