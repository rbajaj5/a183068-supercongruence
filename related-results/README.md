...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 37 proved here, 17 source-closed, 25 partial, 7 with no explicit open target, 24 open targets, and none queued |
