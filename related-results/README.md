...
| 1B | [Peter Bala's OEIS queue](BalaOeisSupercongruenceQueue.md) | Proves the A365029 boundary family and the complete A375178 prime-level odd-power family; separates three deeper towers as computational targets | Two complete elementary proofs and 719 exact checks; priority preliminary |
