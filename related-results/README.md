...
| 1B-X | [Dixon--Legendre half-binomial towers](DixonLegendreHalfBinomialTowers.md) | Uses Dixon's evaluation and a complete half-binomial unit block to prove A275652 and A275654 in one parameter family | Complete elementary proof candidate; 961 exact checks; small-prime failures explicit |
...
| 2A | [A183068 representation and divided Frobenius packet](A183068RepresentationFrobeniusPacket.md) | Turns the constant-term model into an exact torus-invariant multiplicity and weight walk; proves all-prime vanishing of the ordinary three-point Hasse--Witt packet, computes the first divided packet, and recovers the recorded OEIS asymptotic from its exact archimedean saddle | Complete structural theorem and exact checks; the displayed small-prime rank pattern is not promoted to an all-prime claim |
...
| A183068 representation and divided Frobenius packet | `verification/related/verify_a183068_representation_packet.py` |
