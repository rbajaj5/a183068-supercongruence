...
| 1B-O | [Complete A375178 odd-power tower](A375178EnhancedOddPowerTower.md) | Proves the full $p^{3r+2m+1}$ tower for every odd exponent $2m+1$ by a universal final-shell harmonic involution | Complete elementary proof candidate; 5,771 exact checks pass |
