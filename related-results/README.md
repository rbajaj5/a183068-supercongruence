...
| 1B | [Peter Bala's OEIS queue](BalaOeisSupercongruenceQueue.md) | Proves the A365029 boundary family and first two adjacent levels, the A375178 prime-level odd-power family, and the A112028/A219562 fifth-power boundaries; closes A333593 via Coster and Jacobsthal--Kazandzidis | Four complete elementary proof packets, published-theorem reductions, and exact checks; enhanced higher towers remain open; priority preliminary |
