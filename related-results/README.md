...
| 1B-I4 | [Uniform Bober half-index theorem](BoberHalfIndexIntegralityTheorem.md) ([independent parity-transfer certificate](BoberHalfIndexIntegralityTowers.md)) | Translates the ordinary Landau function by $1/2$ at odd primes and controls the binary digit sum at two | Closes all eleven half-index variants; two independent proof packets and checkers; priority pending |
| 1B-I5 | [Bober denominator-boundary theorem](BoberDenominatorBoundaryTheorem.md) ([independent transfer certificate](BoberRemainingFractionalIntegralityTowers.md)) | Translates the ordinary Landau function for denominators three/four and controls the exceptional primes by digit sums | Closes the last four source-visible fractional variants; two independent proof packets and checkers; priority pending |
...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 47 proved here, 20 source-closed, 36 partial, 7 with no explicit open target, no wholly untreated records, and none queued |
...
| 1B-A376 | [A376 Apéry-companion reduction](A376AperyCompanionReduction.md) | Closes all stated A376458 moduli, refutes the A376466 shifted tower, and reduces its surviving ordinary tower | Partial resolution; only A376466's scaled Cartier boundary remains |
