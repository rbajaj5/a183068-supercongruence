...
| 1B-CF | [Two-parameter coefficient-framing tower](CoefficientFramingCubicTower.md) | Identifies six Bala/OEIS records, including the full A352373 parameter family, as one rational-framing theorem and gives an elementary Cartier proof of the specialization | Published theorem specialization; 5,473 exact checks; no priority claim |
...
| 1B-S | [110-record proof-campaign ledger](Bala110ProofCampaign.md) | Gives every census record a route, conservative status, evidence pointer, and next proof operation | Complete machine-readable ledger; 20 proved here, 18 source-closed, 17 partial, 3 with no explicit open target, and 52 queued |
