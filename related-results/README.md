...
| 1B-A376 | [A376 Apéry-companion reduction](A376AperyCompanionReduction.md) | Closes all stated A376458 moduli, refutes the A376466 shifted tower, and reduces its surviving ordinary tower | Partial resolution; the A376466 unit shell is now one explicit kernel lemma |
| 1B-A376B | [A376466 two-moment reduction](A376466OrdinaryTower.md) | Cancels the unit harmonic defect and turns the ordinary cubic tower into reciprocal first/second moments | Conditional proof after one quadratic Cartier-kernel lemma; 8,251 exact checks |
