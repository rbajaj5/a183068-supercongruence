...
| 1B-AUG2 | [August mixed-binomial follow-on](BalaAugustMixedBinomialFollowOn.md) | Proves a coefficientwise Frobenius theorem for products of generalized binomials with signed upper slopes and weighted lower indices; closes A333473, classifies fixed products and twists, closes A333592 via Coster, and separates two counterexamples from two surviving companions | Complete elementary theorem and classical reduction; 3,186 exact checks; larger A333473 algebraic family and cubic mixed negative-binomial tower remain open |
