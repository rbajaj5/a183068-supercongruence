...
| 7 | [Gaussian canonical-product synthesis](GaussianLucasCanonicalProducts.md) | Extracts the dominant logarithmic-moment mechanism, proves that the normalized ramified block is a bijective disk isometry, and exhibits the sharp anisotropic weighted polydisc with distinct unit and odd--odd radii | Proved local theorem plus open research program; 3,000 exact pair checks and four sharp witnesses |
