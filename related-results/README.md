...
| 16 | [Exact dyadic orientation lifts, Dehn twists, and affine symmetry](GQ2OrientationLifts.md) | Gives a clean comparison case for small-prime lifting, identifies the source's shear as outer Dehn twists, and computes the exact affine commutator filtration | Complete elementary sharpening and structural extraction from Roe--Turturean; checked through \(2^{32}\); no novelty claim |
