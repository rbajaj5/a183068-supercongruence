...
| 7 | [Gaussian canonical-product synthesis](GaussianLucasCanonicalProducts.md) | Extracts the dominant logarithmic-moment mechanism, proves that the normalized ramified block is a bijective disk isometry, and exhibits an explicit full-dimensional weighted isometry ball with optimal uniform radius | Proved local theorem plus open research program; 1,800 exact pair checks and two sharp witnesses |
