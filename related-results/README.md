...
| 1B-AUG2B | [Index-dependent companion prime boundary](IndexDependentCompanionPrimeBoundary.md) | Proves the $p^3$ first level for both surviving substitution families by a two-state Lucas calculation and half-residue inverse-square cancellation | Complete prime-boundary theorem with 12,978 exact checks; higher levels remain open |
