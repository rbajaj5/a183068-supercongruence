...
therefore symmetries of the existing proof tower, not a separate analogy.
...
continuous group-theoretic section. Equivalently, one can compute the
extension cocycle produced by choices of unit-scaling lifts and decide
whether it vanishes.
