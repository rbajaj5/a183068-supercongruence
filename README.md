...
| Review Bala's August coefficient follow-up | [A119258 rays and Chebyshev packet](related-results/BalaAugustCoefficientPacket.md), [mixed-binomial follow-on](related-results/BalaAugustMixedBinomialFollowOn.md), and [negative-binomial prefix theorem](related-results/MixedNegativeBinomialCubicTower.md) | Two infinite coefficient families have no denominator-prime exclusions; A333473 and the fixed product/twist class are closed; the false negative-binomial bonus is corrected and its full cubic tower is proved for $p\ge5$ |
