...
| Dyadic structure | [Dyadic policy](DYADIC_POLICY.md), [Euler-product defect](related-results/DyadicHypercubeDefect.md), [Roe-inspired packet](ROE_2ADIC.md), [finite abelian \(2\)-target counts](related-results/GQ2FiniteAbelianCounts.md) | Explicit binary normalization, parity, finite-shadow tests, uniform lift fibers, and first-level boundary analysis |
