...
| Review Bala's Bober follow-up | [Bober sporadic packet](related-results/BoberSporadicFactorialRatioPacket.md), [eleven half-index theorems](related-results/BoberHalfIndexIntegralityTowers.md), [A364176 affine-Landau theorem](related-results/A364176AffineLandauTower.md) | All 52 ordinary towers proved for $p\ge5$; all eleven $N/2$ variants are integral with full cubic towers; two $N/3$ and two $N/4$ integrality claims remain |
...
two binary digit-sum certificates. Four global integrality claims remain:
two at $N/3$ and two at $N/4$.
