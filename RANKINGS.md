...
| 20 | [NEG-FIRST-KERNEL: normalized negative-binomial defect](related-results/BalaAugustFirstDefectKernel.md) | **5** | 1 | 6 | 8 | 8 | 4 | Complete first-layer Cartier reduction for every positive slope and cutoff at $p\ge5$: the normalized defect is one kernel moment and cubic sharpness is classified by its residue; 1,474 checks pass, while the final Cartier-fixed moment identity remains open. |
| 20 | [NEG-PREFIX-3: exact ternary prefix obstruction](related-results/PrimeThreeNegativeBinomialBoundary.md) | **5** | 1 | 6 | 8 | 8 | 4 | Complete first-level residue theorem and maximal parameter-residue classification: $3\mid nab(a+b)$ is sufficient, while all four excluded triples fail sharply; 34,942 checks pass and the all-level renormalization remains conjectural. |
...
| 24 | [NEG-BINOM-DEFECT: Bernoulli obstruction to an exponent bonus](related-results/BalaAugustCoefficientPacket.md#6-the-negative-binomial-strengthening-is-false) | **4** | 1 | 4 | 6 | 9 | 2 | Complete prime-level formula $u(p)\equiv3+2p^3B_{p-3}\pmod {p^4}$ and exact failures of the proposed stronger claims; NEG-PREFIX-CUBIC proves $p\ge5$ and NEG-PREFIX-3 proves the first ternary level, leaving all-level ternary propagation and defect stabilization open. |
