...
| 24 | [NEG-BINOM-DEFECT: Bernoulli obstruction to an exponent bonus](related-results/BalaAugustCoefficientPacket.md#6-the-negative-binomial-strengthening-is-false) | **4** | 1 | 4 | 6 | 9 | 2 | Complete prime-level formula $u(p)\equiv3+2p^3B_{p-3}\pmod {p^4}$ and exact failures of the proposed stronger claims; NEG-PREFIX-CUBIC proves the corrected tower for $p\ge5$, leaving $p=3$ and defect stabilization open. |
