...
| 2 | [BALA-TOWERS: A365029 and A375178 towers](related-results/BalaOeisSupercongruenceQueue.md#5-exact-status-of-the-remaining-first-queue) | **7** | 1 | 6 | 8 | 3 | 7 | Two named OEIS prime-power targets with 145 exact checks; the A333593 tower and the prime-level A365029 and A375178 components are now closed. |
