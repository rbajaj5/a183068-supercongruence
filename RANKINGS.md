...
| 34= | [GQ2-LIFT: orientation lifting, Dehn twists, and affine symmetry](related-results/GQ2OrientationLifts.md) | **4** | 1 | 3 | 7 | 9 | 1 | Complete elementary sharpening, an exact \(\mathbb Z_2\)-tower of outer Dehn twists, and the affine commutator filtration; no novelty claim and no effect on the source's main theorem. |
