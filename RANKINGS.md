...
| 20 | [INDEX-COMPANION-SHELL: substitution-family boundary and scaled shells](related-results/IndexDependentCompanionPrimeBoundary.md) | **5** | 1 | 6 | 7 | 9 | 2 | Complete $p^3$ boundary theorem for both surviving index-dependent companions plus termwise $p^{3r}$ transfer on every scaled shell; quadratic substitution reduces the remaining tower to one carry-aware unit-shell identity; 14,004 checks pass. |
