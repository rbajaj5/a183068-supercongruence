...
| 20 | [A183068-FROB: torus representation and divided Frobenius packet](related-results/A183068RepresentationFrobeniusPacket.md) | **5** | 2 | 3 | 7 | 9 | 2 | Exact invariant-multiplicity and weight-walk models, an all-prime vanishing theorem for the ordinary three-point Hasse--Witt packet, the first divided packet, and a structural derivation of the asymptotic already recorded on OEIS; the small-prime rank pattern is computational. |
