...
| 20 | [INDEX-COMPANION-P1: substitution-family prime boundary](related-results/IndexDependentCompanionPrimeBoundary.md) | **5** | 1 | 6 | 7 | 9 | 2 | Complete $p^3$ boundary theorem for both surviving index-dependent companions via half-residue cancellation; 12,978 checks pass, with higher levels open. |
