...
| **C: exact infrastructure** | DYADIC-Q, DYADIC-WALSH, DYADIC-JOINT, BLACK-WALSH, HASH-MATROID, FQ-CT, WALK-FROB, EHRHART-CUTOFF, GQ2-ABCOUNT, GQ2-DIHEDRAL, GQ2-QUATERNION, GQ2-MAXCYCLIC, GQ2-EXTRASPECIAL | Improve experiments, certification, source consolidation, and proof organization |
...
| 27 | [EHRHART-CUTOFF: Newton-polytope rank primes](related-results/EhrhartNewtonPrimeCutoff.md) | **4** | 1 | 3 | 7 | 9 | 1 | Complete sharp determinant cutoff deduced from the accepted Lean-certified Ehrhart volume theorem; it makes eligible bad-rank prime searches finite but does not improve a valuation exponent. |
