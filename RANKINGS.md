...
| 24 | [NEG-HIGHER-DEFECT: three-level higher-lift reduction](related-results/BalaAugustHigherDefectLift.md) | **4** | 1 | 5 | 7 | 7 | 5 | Exact division-free reduction, three-shell decomposition, and logarithmic degree-four boundary for the last August conjecture; 405 checks pass, but the higher-Frobenius estimate remains open. |
