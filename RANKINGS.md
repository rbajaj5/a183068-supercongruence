...
| 3 | [BOBER-FRAC: fractional Bober integrality queue](related-results/BoberSporadicFactorialRatioPacket.md) | **6** | 1 | 6 | 8 | 8 | 3 | Quotient transfer proved for all 15 visible variants and all eleven half-index cases are now integral; only two third-index and two quarter-index integrality targets remain. |
