...
| 34= | [GQ2-LIFT: exact dyadic orientation lifting and Dehn twists](related-results/GQ2OrientationLifts.md) | **4** | 1 | 3 | 6 | 9 | 1 | Complete elementary sharpening plus an exact \(\mathbb Z_2\)-tower of outer Dehn twists acting on the defect stages; no novelty claim and no effect on the source's main theorem. |
