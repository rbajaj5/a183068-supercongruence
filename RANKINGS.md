...
| 11 | [GL-ISO: ramified Gaussian disk isometry](related-results/GaussianLucasCanonicalProducts.md#6-the-mixed-block-product-is-an-exact-disk-isometry) | **7** | 4 | 7 | 8 | 8 | 4 | Complete deduction plus a sharp anisotropic weighted isometry polydisc, with distinct optimal radii for unit and odd--odd residues; 3,000 exact pair checks and four sharp witnesses pass. |
...
| 20 | [NEG-PREFIX-3: exact ternary prefix obstruction](related-results/PrimeThreeNegativeBinomialBoundary.md) | **5** | 1 | 6 | 8 | 8 | 4 | Complete first-level residue theorem, cubic subclass containing Bala's sum, and sharp counterexample to a universal $p=3$ extension; 20,933 checks pass, while the all-level renormalization remains conjectural. |
