...
| 20 | [A183068-FROB: torus representation and divided Frobenius packet](related-results/A183068RepresentationFrobeniusPacket.md) | **5** | 2 | 4 | 7 | 9 | 2 | Exact invariant-multiplicity and weight-walk models, all-prime vanishing of the ordinary three-point Hasse--Witt packet, an exact divided-packet rank \(1\) at \(2\) versus rank \(2\) at every odd prime, and a structural derivation of the asymptotic already recorded on OEIS. |
