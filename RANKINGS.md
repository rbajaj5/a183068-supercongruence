...
| 20 | [EULER-CUBIC-MOMENTS: one-obstruction reduction](related-results/EulerProductCubicCartierMoments.md) | **5** | 1 | 6 | 8 | 9 | 3 | Exact all-level reduction of four route-M records and A380290 to one coefficientwise Cartier-square stratum bound; both weighted moments and all higher logarithmic degrees are eliminated, with 4,546 exact checks. |
...
| 2 | [TAYLOR-7: Catalan--Schröder truncation packet](related-results/TaylorTruncationCoefficientReduction.md) | **7** | 1 | 5 | 9 | 5 | 5 | Seven OEIS records reduced exactly to two all-parameter coefficient families; two explicit Catalan Cartier estimates and the Schröder Gaussian-prefactor analogue remain open. |
