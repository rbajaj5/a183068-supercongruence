...
| 28= | [JC-PRED: exact predictive-state complexity](related-results/FrobeniusPredictiveStateTheorem.md) | **5** | 4 | 4 | 8 | 9 | 2 | Complete exact model-selection boundary: no valuation lumping, minimal memory $1{,}824$, full $19{,}500$-state future quotient, and an explicit non-mixing theorem. |
...
JC-WL $\rightarrow$ JC-AUTO $\rightarrow$ JC-THERMO $\rightarrow$ JC-PRED
$\rightarrow$ JC-LIFT
...
JC-PRED proves that the scalar valuation output cannot be compressed into a
smaller exact Markov state: $1{,}824$ lags are necessary, and that history
already identifies the full $19{,}500$-phase clock.
