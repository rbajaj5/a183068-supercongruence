...
| 34= | [GQ2-LIFT: exact dyadic orientation lifting](related-results/GQ2OrientationLifts.md) | **4** | 1 | 3 | 5 | 9 | 1 | Complete elementary sharpening of a published remark, with exact classes checked through \(2^{32}\); no novelty claim and no effect on the source's main theorem. |
