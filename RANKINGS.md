...
| **C: exact infrastructure** | DYADIC-Q, DYADIC-WALSH, DYADIC-JOINT, BLACK-WALSH, HASH-MATROID, FQ-CT, WALK-FROB, PELL-FROB, GQ2-ABCOUNT, GQ2-DIHEDRAL, GQ2-QUATERNION, GQ2-MAXCYCLIC, GQ2-EXTRASPECIAL | Improve experiments, certification, source consolidation, and proof organization |
...
| 25 | [PELL-FROB: signed Pell--Lucas Frobenius tower](related-results/PellLucasFrobeniusTower.md) | **4** | 1 | 1 | 6 | 10 | 1 | Complete quadratic-unit proof and exact split/inert refinement of a published Lucas congruence; useful local testbed and abc/IUT boundary, with no novelty claim. |
...
| 3 | [BOBER-FRAC: fractional Bober integrality queue](related-results/BoberSporadicFactorialRatioPacket.md) | **6** | 1 | 5 | 8 | 5 | 5 | Conditional cubic transfer proved for all 15 currently visible variants; exact integrality holds through $N=30$, but global integrality remains the named open obligation and A295464 awaits approved source text. |
