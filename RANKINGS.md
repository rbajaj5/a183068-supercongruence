...
| 15 | [CAT-PRIME: all odd Catalan-ballot powers](related-results/CatalanBallotPrimeLevelTheorem.md) | **6** | 1 | 6 | 9 | 8 | 3 | Complete elementary \(p^3\) prime-level theorem for every odd exponent, proving the first slice of five named OEIS formulations; 557 exact checks pass and higher levels remain open. |
...
| 2 | [CAT-ODD: Catalan ballot-power supercongruences](related-results/CatalanBallotPowerSupercongruenceAudit.md) | **7** | 1 | 5 | 8 | 4 | 6 | The common prime slice is proved for every odd exponent; arbitrary \(n,r\) and the sharp \(p=2,3\) refinements remain open. |
