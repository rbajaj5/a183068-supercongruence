...
| 15 | [MIXED-BINOMIAL: signed-slope polynomial Frobenius theorem](related-results/BalaAugustMixedBinomialFollowOn.md) | **6** | 1 | 5 | 10 | 8 | 3 | Complete factor-count theorem for weighted generalized-binomial products and twists; closes A333473, supplies the unconditional quadratic baseline for the negative-binomial sum, and isolates a rapidly stabilizing conjectural cubic defect; 3,390 checks pass. |
...
| 24 | [NEG-BINOM-DEFECT: Bernoulli obstruction to an exponent bonus](related-results/BalaAugustCoefficientPacket.md#6-the-negative-binomial-strengthening-is-false) | **4** | 1 | 4 | 6 | 9 | 2 | Complete prime-level formula $u(p)\equiv3+2p^3B_{p-3}\pmod {p^4}$, exact failures of the proposed stronger claims, and an unconditional all-level quadratic tower from MIXED-BINOMIAL; only the ordinary cubic lift remains open. |
...
| 32 | [QUADRATIC-GAUSSIAN: A005259/A333592-family polynomial towers](related-results/QuadraticGaussianQueueTheorem.md) | **3** | 1 | 1 | 6 | 9 | 1 | Complete all-prime coefficientwise \(p^{2r}\) deduction for A005259 and every positive parameter pair in the A333592 family; the named untwisted A333592 cubic specialization is separately Coster-closed in MIXED-BINOMIAL. |
