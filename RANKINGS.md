...
| 34= | [GQ2-LIFT: orientation lifting, Dehn twists, affine symmetry, and sampling](ROE_2ADIC.md) | **4** | 3 | 3 | 8 | 9 | 1 | Complete elementary sharpening, an exact $\mathbb Z_2$-tower of outer Dehn twists, affine commutator filtration, optimal finite-level sampler, explicit refresh spectrum, fixed-generator cyclotomic gap bounds, and a nonzero $\mathbb Z/2$ linear obstruction proxy; no novelty claim and no effect on the source's main theorem. |
