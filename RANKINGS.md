...
| 11 | [GL-ISO: ramified Gaussian disk isometry](related-results/GaussianLucasCanonicalProducts.md#6-the-mixed-block-product-is-an-exact-disk-isometry) | **7** | 4 | 7 | 8 | 8 | 4 | Complete deduction plus an explicit full-dimensional weighted isometry ball with optimal uniform radius; 1,800 exact pair checks and two sharp witnesses pass. |
