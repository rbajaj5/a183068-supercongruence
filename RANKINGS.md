...
| 20 | [DYADIC-Q: binary hypercube defect](related-results/DyadicHypercubeDefect.md) | **5** | 2 | 2 | 9 | 9 | 2 | Complete sharp \(2^{2r-1}\) Euler-product tower and exact modulus-\(4\) quadratic-defect classification; standard \(2\)-derivation infrastructure, with no priority claim. |
