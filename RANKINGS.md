...
| 15 | [A365029-R1: full prime-level adjacent congruence](related-results/A365029PrimeLevelTheorem.md) | **6** | 1 | 6 | 7 | 7 | 3 | Complete elementary proof of the \(r=1\) case of a named OEIS \(p^{3r}\) tower; the reciprocal-square block cancellation is proved and 35,356 exact checks pass. |
...
| 2 | [BALA-TOWERS: higher A365029 and A375178 towers](related-results/BalaOeisSupercongruenceQueue.md#5-exact-status-of-the-remaining-first-queue) | **7** | 1 | 6 | 8 | 5 | 5 | Two named OEIS prime-power targets: A365029 is now proved at \(r=1\) and reduced above it to a complete-block lifting lemma with 177 exact checks; Coster supplies the cubic baseline beneath A375178. |
