...
| 15 | [NEG-HIGHER-DEFECT: higher normalized-defect theorem](related-results/BalaAugustHigherDefectLift.md) | **6** | 1 | 6 | 8 | 8 | 3 | Complete $p\ge5$ proof candidate: the second Cartier connection cancels the critical cubic Hessian term after the exact three-shell and quartic reductions; 2,200 checks pass, with independent review and priority work pending. |
