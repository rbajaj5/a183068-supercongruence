...
| 25 | [DYADIC-JOINT: joint spectrum of the binary defect](related-results/DyadicHypercubeJointSpectrum.md) | **4** | 4 | 2 | 9 | 10 | 1 | Exact joint model counts for arbitrary finite output sets via alternating convolution ranks and radical tests; useful verification synthesis built on classical quadratic-form Fourier analysis. |
