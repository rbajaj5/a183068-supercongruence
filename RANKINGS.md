...
| 20 | [NEG-PREFIX-3: exact ternary prefix obstruction](related-results/PrimeThreeNegativeBinomialBoundary.md) | **5** | 1 | 6 | 8 | 8 | 4 | Complete first-level residue theorem and maximal slope-residue classification: $3\mid ab(a+b)$ is sufficient, while both excluded classes fail sharply; 32,936 checks pass and the all-level renormalization remains conjectural. |
