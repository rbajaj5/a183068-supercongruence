...
| 15 | [BALA-BINOMIAL: A357568 enhanced family](related-results/BinomialQuotientCancellation.md#4-the-a357568-family) | **6** | 1 | 6 | 8 | 8 | 3 | Complete proof candidate for every odd prime, every level \(r\ge2\), and every power parameter \(k\ge1\); the named OEIS conjecture is \(k=2\), and 180 exact family checks include 140 sharp cases. |
