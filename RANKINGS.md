...
| --- | --- | --- |
| **A: specialist review now** | SYMBOX-4, ZHANG-4, FRAMING-COUNTEREX, GWL-TWO, GWL-SCALE, GL-AFFINE, JC-WL, JC5-FF, BOBER-FRAC-ALL, A183068 | Check proofs and priority before extending the statements |
...
| 15 | [BOBER-HALF: eleven half-index integrality theorems](related-results/BoberHalfIndexIntegralityTowers.md) | **6** | 1 | 7 | 9 | 8 | 3 | One parity-transfer and binary digit-sum proof closes all eleven approved $N/2$ integrality conjectures and their $p^{3r}$ towers; 59,467 exact checks pass, with priority and specialist review pending. |
| 14 | [BOBER-FRAC-ALL: all 15 fractional-index Bober towers](related-results/BoberRemainingFractionalIntegralityTowers.md) | **7** | 1 | 7 | 9 | 8 | 3 | The half-index theorem plus a coprime-modulus Landau transfer and exact denominator-prime table close every approved fractional-index integrality conjecture and its $p^{3r}$ tower; 84,338 new exact checks pass, with priority and specialist review pending. |
