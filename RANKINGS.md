...
| **D: retained open targets** | C11, CAT-ODD, BALA-TOWERS, BALA-BLOCK, APERY-DEFECT, s18-2 | Spend proof effort only against the explicit unresolved lemma or obstruction |
...
| 3 | [BALA-BLOCK: eight paired Apéry towers](related-results/BalaPairedResidueBlockExperiment.md) | **7** | 1 | 4 | 8 | 3 | 7 | One exact residue-block transfer target would close the unshifted half of eight named \(p^{3r}\) conjectures; 560 checks pass, but no proof, group action, or shifted-tower reduction is claimed. |
