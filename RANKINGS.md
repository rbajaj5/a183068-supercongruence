...
| 15 | [MIXED-BINOMIAL: signed-slope polynomial Frobenius theorem](related-results/BalaAugustMixedBinomialFollowOn.md) | **6** | 1 | 5 | 10 | 8 | 3 | Complete factor-count theorem for weighted generalized-binomial products and twists; closes A333473, supplies the unconditional quadratic baseline for the negative-binomial sum, and separates exact counterexamples from viable companions; 3,186 checks pass. |
