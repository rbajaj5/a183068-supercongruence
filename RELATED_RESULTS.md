...
| [Peter Bala's OEIS queue](related-results/BalaOeisSupercongruenceQueue.md) | Proves the first A365029 conjecture in the stronger \(p^{A+B}\) form and proves the complete A375178 prime-level odd-power family; records three deeper towers separately | Two complete elementary proofs with 719 exact checks; priority preliminary |
