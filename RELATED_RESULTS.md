...
| [Cooper level-11 rare primes](related-results/CooperLevel11RarePrimes.md) | Isolates the $n=1$ obstruction and a 350-case first-order law that would make it equivalent to every $r=1$ congruence; rejects the naive $X_0(11)$ trace-$2$ explanation; identifies a conditional finite-automaton proof route once a rational diagonal is exhibited | Computational theorem target; automaton premise not yet established |
