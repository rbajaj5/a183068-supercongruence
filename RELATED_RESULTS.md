...
| [Gaussian product dynamics](related-results/GaussianProductDynamicsConjectures.md) | Conjectures an exact return-valuation law and conjugacy to addition for unit translations of the ramified disk isometry; all tested finite quotients have the predicted non-ergodic cycle profile | Exact computational conjectures |
