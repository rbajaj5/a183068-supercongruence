...
| [Dyadic hypercube defect](related-results/DyadicHypercubeDefect.md) | Proves the sharp universal \(2^{2r-1}\) replacement and identifies the exact modulus-\(4\) obstruction as a quadratic Boolean map on the two coefficient-bit layers | Complete elementary theorem with exact checks; standard \(2\)-derivation infrastructure and no priority claim |
