...
| [110-record Bala proof campaign](related-results/Bala110ProofCampaign.md) | Tracks every record in the reproducible census separately, with route, status, evidence, and next action | Complete ledger: 10 proved here, 12 source-closed, 11 partial, 3 with no explicit open target, 74 queued for exact claim extraction |
