...
| [Exact predictive-state complexity](related-results/FrobeniusPredictiveStateTheorem.md) | Proves that the degree-seven valuation output is not lumpable, needs $1824$ scalar lags for exact prediction, and has the full $19500$-state future quotient; separates deterministic non-mixing from a deliberately randomized phase walk | Complete exact model-selection theorem with an explicit minimality witness and direct checker |
