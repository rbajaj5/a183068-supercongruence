...
| [110-record Bala proof campaign](related-results/Bala110ProofCampaign.md) | Tracks every record in the reproducible census separately, with route, status, evidence, and next action | Complete ledger: 17 proved here, 12 source-closed, 15 partial, 3 with no explicit open target, 63 queued |
