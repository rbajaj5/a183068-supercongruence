...
| [Gaussian base change for Jacobian collisions](related-results/GaussianBaseChangeJacobianCollisions.md) | Recasts the corrected tower over prime ideals, proves the exact \(2ef(r-1)\) valuation, and shows that inert Gaussian base change squares Frobenius and removes the degree-four quadratic Artin obstruction | Complete structural and degree-four theorem with exact split/inert checks; literature priority provisional |
