...
| [Weighted Hensel valuation filter](related-results/HenselValuationFilter.md) | Classifies the \(28\) inverse-limit roots with weights \(1,5,25\), proves the exact density tail \(4/(39\cdot5^{k-2})\), and gives the partition polynomial at every precision | Complete structural theorem with an independent \(5^7\) full-cycle certificate; literature priority provisional |
