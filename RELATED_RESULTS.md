...
| [Peter Bala's OEIS queue](related-results/BalaOeisSupercongruenceQueue.md) | Proves the A365029 boundary theorem and full \(r=1\) adjacent congruence, proves the complete A375178 prime-level odd-power family, and closes the A333593 tower by reduction to Coster and Jacobsthal--Kazandzidis | Three complete elementary proofs plus published-theorem reductions; priority preliminary |
| [A365029 prime-level theorem](related-results/A365029PrimeLevelTheorem.md) | Establishes \(a(np)\equiv a(n)\pmod {p^3}\) by combining shifted scaling with half-system reciprocal-square cancellation | Complete unchecked proof and 35,356 exact checks; higher tower reduced to a block-lifting target |
