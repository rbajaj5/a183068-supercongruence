...
| [Gaussian Lucas canonical products](related-results/GaussianLucasCanonicalProducts.md) | Recasts the inert and ramified proofs as local analytic products, extracts the dominant-first-moment mechanism, and identifies the split-prime normalization problem | Proved synthesis plus open research program |
