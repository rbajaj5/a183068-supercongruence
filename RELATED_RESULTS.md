...
| [Affine grammar and dyadic-twist almost periodicity](related-results/DyadicTwistGrammarAlmostPeriodicity.md) | Gives affine words a unique translation-first normal form and specializes finite-group almost periodicity to dense averages of Dehn-twist observables; the structured phases are cyclotomic | Exact grammar deduction plus a cited Wigderson/Croot--Sisask corollary; no novelty claim |
| [Compatible Galois lift towers](related-results/GaloisRepresentationLiftTowers.md) | Places the lift/defect architecture in general deformation theory: compatible finite representations converge, one-step failures define $H^2$ classes, and corrections form an $H^1$ torsor; it separates true Galois lifts from scalar congruence shadows | Self-contained exposition of standard infrastructure with exact finite checks; Khare/Fakhruddin--Khare--Patrikis/Merkurjev--Scavia source boundary, no novelty claim |
