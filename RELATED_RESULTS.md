...
| [Peter Bala's OEIS queue](related-results/BalaOeisSupercongruenceQueue.md) | Proves the first A365029 conjecture in the stronger \(p^{A+B}\) form, proves the complete A375178 prime-level odd-power family, and closes the A333593 tower by reduction to Coster and Jacobsthal--Kazandzidis; records two deeper towers separately | Two complete elementary proofs plus one published-theorem reduction, with 1,175 exact checks; priority preliminary |
