...
| [110-record Bala proof campaign](related-results/Bala110ProofCampaign.md) | Tracks every record in the reproducible census separately, with route, status, evidence, and next action | Complete ledger: 4 proved here, 12 source-closed, 4 partial, 2 with no explicit open target, 88 queued for exact claim extraction |
